...
const storeItems = [
    {
        ...
        description: 'Pioneer HDJ2000 Limited Edition. Ibiza 2010s. Blanco y Negro record label official product. 40 units ever built. Handmade by master jewelers with aprox. 4.000~ SWAROVSKI ELEMENTS T crystals.'
       +   ' <p> Comes with the Pioneer Blanco y Negro cover box, a hard plastic protective case, and the business card of the jewelry store that made them. Mint condition. </p>'
